(function () {
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["highlight-js-lib-languages-xml"], {
    /***/
    "jctj": function jctj(module, exports) {
      /**
       * @param {string} value
       * @returns {RegExp}
       * */
...
//# sourceMappingURL=highlight-js-lib-languages-xml-es5.js.map