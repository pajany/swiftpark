(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.rxweb = global.rxweb || {}, global.rxweb['reactive-form-validators'] = {}), global.ng.core, global.ng.common, global.ng.forms, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    var ObjectMaker = /** @class */ (function () {
        ...
        ObjectMaker.getDateString = function (value) {
            var seperator = ReactiveFormConfig && ReactiveFormConfig.json && ReactiveFormConfig.json.baseConfig && ReactiveFormConfig.json.baseConfig.seperator ? ReactiveFormConfig.json.baseConfig.seperator : "/";
            var dateFormat = ReactiveFormConfig && ReactiveFormConfig.json && ReactiveFormConfig.json.baseConfig && ReactiveFormConfig.json.baseConfig.dateFormat ? ReactiveFormConfig.json.baseConfig.dateFormat : "mdy";
    ...
    var RxFormArray = /** @class */ (function (_super) {
        ...
        RxFormArray.prototype.push = function (control, options) {
            if (options === void 0) { options = { isAddedInstance: false }; }
        ...
        RxFormArray.prototype.removeAt = function (index, options) {
            if (options === void 0) { options = { isRemovedInstance: false }; }
            var formGroup = this.root;
            ...
            _super.prototype.removeAt.call(this, index, options);
            if (formGroup[VALUE_CHANGED_SYNC])
                formGroup.valueChangedSync();
            this.patch();
            this.checkValidation();
    ...
    exports.NumericValueType = void 0;
    ...
    exports.ErrorMessageBindingStrategy = void 0;
    ...
    var ApplicationUtil = /** @class */ (function () {
        ...
        ApplicationUtil.cloneValue = function (value) {
            return ApplicationUtil.isObject(value) ? ApplicationUtil.isArray(value) ? __spreadArray([], __read(value)) : Object.assign({}, value) : value;
        };
    ...
    var DateProvider = /** @class */ (function () {
        ...
        DateProvider.prototype.regex = function (config) {
            var regExp;
            if (ReactiveFormConfig && ReactiveFormConfig.json && ReactiveFormConfig.json.internationalization && ReactiveFormConfig.json.internationalization.dateFormat && ReactiveFormConfig.json.internationalization.seperator)
        ...
        DateProvider.prototype.getDate = function (value, configDateFormat, isBaseFormat) {
            var _a, _b, _c;
            if (configDateFormat === void 0) { configDateFormat = undefined; }
    ...
    var RxFormControl = /** @class */ (function (_super) {
        ...
        RxFormControl.prototype.defineErrorsProperty = function () {
            Object.defineProperty(this, "errors", {
                ...
                set: function (value) { this._errors = value; },
            });
        };
        ...
        RxFormControl.prototype.getValidatorSource = function (validators) {
            if (validators)
                return Array.isArray(validators) ? __spreadArray([], __read(validators)) : [validators];
            return [];
        };
        ...
        RxFormControl.prototype.reset = function (value, options) {
        ...
        RxFormGroup.prototype.isDirty = function () {
            ...
            for (var name in this.value) {
                ...
                if (!(this.controls[name] instanceof forms.FormGroup || this.controls[name] instanceof forms.FormArray)) {
                    ...
                    try {
                        for (var _b = (e_1 = void 0, __values(this.controls[name].controls)), _c = _b.next(); !_c.done; _c = _b.next()) {
                            var formGroup = _c.value;
        ...
        RxFormGroup.prototype.resetForm = function (options) {
            for (var name in this.controls) {
                if (isResetControl(name, this.controls[name], options)) {
                    if (this.controls[name] instanceof forms.FormGroup)
        ...
        RxFormGroup.prototype.patchModelValue = function (value, options) {
            ...
            if (value) {
                for (var name in this.controls) {
                    ...
                    else if (this.controls[name] instanceof forms.FormArray && Array.isArray(value[name])) {
                        var index = 0;
                        try {
                            for (var _b = (e_2 = void 0, __values(this.controls[name].controls)), _c = _b.next(); !_c.done; _c = _b.next()) {
                                var formGroup = _c.value;
                                if (value[name][index])
    ...
    var RELATIONAL_OPERATOR_CONFIG = "RelationalOperatorConfig";

    var _a$1;
    var CONFIG_REQUIRED_FIELDS = (_a$1 = {},
        _a$1[ARRAY_CONFIG] = ["matchValues"],
        _a$1[FIELD_CONFIG] = ["fieldName"],
        _a$1[IP_CONFIG] = ["version"],
        _a$1[PASSWORD_CONFIG] = ["validation"],
        _a$1[NUMBER_CONFIG] = ["value"],
        _a$1[PATTERN_CONFIG] = ["expression"],
        _a$1[RANGE_CONFIG] = ["minimumNumber", "maximumNumber"],
        _a$1);
    ...
    function containsValidator(configModel) {
        return function (control) {
            ...
            if (ValidatorValueChecker.pass(control, config)) {
                var failed = false;
                var values = config.values ? config.values : [config.value];
                try {
        ...
        if (FormProvider.ProcessRule(control, config)) {
            if (RegexValidator.isNotBlank(control.value)) {
                ...
                if (dateProvider.isDate(control.value) || dateProvider.isValid(control.value, config)) {
                    ...
                    var isValid = operationType == AnnotationTypes.minDate ? runCondition$1(currentControlValue, checkDate, config.operator || OPERATORS.greaterThanEqualTo) : runCondition$1(checkDate, currentControlValue, config.operator || OPERATORS.lessThanEqualTo);
                    if (!isValid)
        ...
        return function (control) {
            ...
            if (ValidatorValueChecker.pass(control, config)) {
                ...
                try {
                    for (var values_1 = __values(values), values_1_1 = values_1.next(); !values_1_1.done; values_1_1 = values_1.next()) {
                        var value = values_1_1.value;
                        var startString = String(control.value).substr(0, value.length);
        ...
        if (FormProvider.ProcessRule(control, config)) {
            if (RegexValidator.isNotBlank(control.value)) {
                if (isValid(control, config)) {
                    ...
                    var isValid_1 = operationType == AnnotationTypes.minTime ? runCondition(currentControlValue, crossControlValue, config.operator || OPERATORS.greaterThanEqualTo) : runCondition(crossControlValue, currentControlValue, config.operator || OPERATORS.lessThanEqualTo);
                    if (!isValid_1)
                        return ObjectMaker.toJson(operationType, config, [control.value]);
                }
                else
    ...
    var RxFormBuilder = /** @class */ (function (_super) {
        ...
        RxFormBuilder.prototype.getValidatorConfig = function (validatorConfig, entityObject, rootPropertyName, arrayPropertyName) {
            ...
            if (!validatorConfig)
                return {};
            var validationProps = this.getObjectForProperty(validatorConfig.dynamicValidation, rootPropertyName, arrayPropertyName);
            var abstractControlOptions = this.getObjectForProperty(validatorConfig.abstractControlOptions, rootPropertyName, arrayPropertyName);
            ...
            var dynamicValidation = (validatorConfig.dynamicValidationConfigurationPropertyName && entityObject[validatorConfig.dynamicValidationConfigurationPropertyName]) ? entityObject[validatorConfig.dynamicValidationConfigurationPropertyName] : validationProps;
        ...
        RxFormBuilder.prototype.getObjectForProperty = function (rootObject, rootPropertyName, arrayPropertyName) {
            var result = {};
            for (var propName in rootObject) {
                if (!propName.startsWith(rootPropertyName) && (!arrayPropertyName || !propName.startsWith(arrayPropertyName)))
                    continue;
                var splitProp = propName.split(".", 2)[1];
                if (!splitProp)
                    continue;
        ...
        RxFormBuilder.prototype.formGroup = function (model, entityObject, formBuilderConfiguration) {
                    ...
                    switch (property.propertyType) {
                        case PROPERTY:
                            if (!(entityObject[property.name] instanceof forms.FormControl || entityObject[property.name] instanceof RxFormControl)) {
                                ...
                                abstractControlOptions_1 = _this.getAbstractControlOptions(property.name, formBuilderConfiguration, abstractControlOptions_1);
                                if (property.updateOn && !abstractControlOptions_1.updateOn)
                                    abstractControlOptions_1.updateOn = property.updateOn;
                        ...
                        case ARRAY_PROPERTY:
                            ...
                            if (arrayObjectValue && arrayObjectValue instanceof Array && !(arrayObjectValue instanceof forms.FormArray)) {
                                ...
                                var abstractControlOptions_2 = _this.getAbstractControlOptions(property.name, formBuilderConfiguration, {});
                                formGroupObject[property.name] = new RxFormArray(arrayObjectValue, formArrayGroup, abstractControlOptions_2, null, property.arrayConfig);
                                if (ReactiveFormConfig.autoInstancePush) {
                                    arrayObjectValue.push = function (instance) { var formGroup = _this.formGroup(instance.constructor, instance, objectValidationConfig_1); formGroupObject[property.name].push(formGroup, { isAddedInstance: true }); return 0; };
            ...
            var formGroup = new RxFormGroup(json.model, json.entityObject, formGroupObject, abstractControlOptions);
        ...
        RxFormBuilder.prototype.getAbstractControlOptions = function (name, formBuilderConfiguration, abstractControlOptions) {
            ...
            var controlOptions = formBuilderConfiguration ? formBuilderConfiguration.baseAbstractControlOptions : null;
                ...
                if (formControl.validatorConfig) {
                    Object.keys(AnnotationTypes).forEach(function (validatorName) {
                        if (formControl.validatorConfig[validatorName] && formControl.validatorConfig[validatorName].disableExpression) {
                            ...
                            columns.forEach(function (t) {
                                defaultContainer.setConditionalValueProp(_this.validationRule, rootFieldName + t.propName, fieldName);
                            });
                        }
    ...
    var SIMPLE_EMAIL_VALIDATION = "simple-email-validation";
    var ADVANCED_EMAIL_VALIDATION = "advanced-email-validation";
    ...
    var RxFormControlDirective = /** @class */ (function (_super) {
        ...
        RxFormControlDirective.prototype.subscribeMaskValidator = function () {
            if (this.formControl[VALIDATOR_CONFIG$2] && this.formControl[VALIDATOR_CONFIG$2]["mask"] && !this.isMasked) {
                var config = this.formControl[VALIDATOR_CONFIG$2]["mask"];
        ...
        RxFormControlDirective.prototype.setTemplateValidators = function (control) {
            for (var validatorName in control[VALIDATOR_CONFIG$2]) {
    ...
    RxFormControlDirective.propDecorators = {
        rxalpha: [{ type: core.Input }],
        rxalphaNumeric: [{ type: core.Input }],
        rxascii: [{ type: core.Input }],
        rxcompare: [{ type: core.Input }],
        rxcompose: [{ type: core.Input }],
        rxcontains: [{ type: core.Input }],
        rxcreditCard: [{ type: core.Input }],
        rxdataUri: [{ type: core.Input }],
        rxdifferent: [{ type: core.Input }],
        rxdigit: [{ type: core.Input }],
        rxemail: [{ type: core.Input }],
        rxendsWith: [{ type: core.Input }],
        rxeven: [{ type: core.Input }],
        rxextension: [{ type: core.Input }],
        rxfactor: [{ type: core.Input }],
        rxfileSize: [{ type: core.Input }],
        rxgreaterThanEqualTo: [{ type: core.Input }],
        rxgreaterThan: [{ type: core.Input }],
        rxhexColor: [{ type: core.Input }],
        rxjson: [{ type: core.Input }],
        rxlatitude: [{ type: core.Input }],
        rxlatLong: [{ type: core.Input }],
        rxleapYear: [{ type: core.Input }],
        rxlessThan: [{ type: core.Input }],
        rxlessThanEqualTo: [{ type: core.Input }],
        rxlongitude: [{ type: core.Input }],
        rxlowerCase: [{ type: core.Input }],
        rxmac: [{ type: core.Input }],
        rxmaxDate: [{ type: core.Input }],
        rxmaxLength: [{ type: core.Input }],
        rxmaxNumber: [{ type: core.Input }],
        rxminDate: [{ type: core.Input }],
        rxminLength: [{ type: core.Input }],
        rxminNumber: [{ type: core.Input }],
        rxnumeric: [{ type: core.Input }],
        rxodd: [{ type: core.Input }],
        rxpassword: [{ type: core.Input }],
        rxport: [{ type: core.Input }],
        rxprimeNumber: [{ type: core.Input }],
        rxrequired: [{ type: core.Input }],
        rxrange: [{ type: core.Input }],
        rxrule: [{ type: core.Input }],
        rxstartsWith: [{ type: core.Input }],
        rxtime: [{ type: core.Input }],
        rxupperCase: [{ type: core.Input }],
        rxurl: [{ type: core.Input }],
        rxunique: [{ type: core.Input }],
        rxnotEmpty: [{ type: core.Input }],
        rxcusip: [{ type: core.Input }],
        rxgrid: [{ type: core.Input }],
        rxdate: [{ type: core.Input }]
    };
    ...
    FileControlDirective.decorators = [
        { type: core.Directive, args: [{
                    ...
                    providers: [{ provide: forms.NG_VALUE_ACCESSOR, useExisting: FileControlDirective, multi: true }, {
                            provide: forms.NG_VALIDATORS,
                            useExisting: core.forwardRef(function () { return FileControlDirective; }),
                            multi: true
                        }]
                },] }
    ];
    ...
    ImageFileControlDirective.decorators = [
        { type: core.Directive, args: [{
                    ...
                    providers: [{
                            ...
                            useExisting: core.forwardRef(function () { return ImageFileControlDirective; }),
                            multi: true
                        }]
                },] }
    ];
    ...
    AsyncValidationDirective.decorators = [
        { type: core.Directive, args: [{
                    ...
                    providers: [{
                            provide: forms.NG_ASYNC_VALIDATORS,
                            useExisting: core.forwardRef(function () { return AsyncValidationDirective; }),
                            multi: true
                        }]
                },] }
    ];
    ...
    function resolveConfig(configModel, validatorName, control) {
        return function (config) {
            var configClone = Object.assign(Object.assign(Object.assign({}, configModel), config), { expressionProcessed: true });
    ...
    exports.UrlValidationType = void 0;
    ...
    })(exports.UrlValidationType || (exports.UrlValidationType = {}));
